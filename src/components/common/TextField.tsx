...
export default function TextField({ category = "default", ...args }: ITextFieldProps) {
  const props = { ...args, category };
  ...
  const typoStyle: Record<TextFieldCategoryType, string> = {
    default: defaultTypoStyle[props.size],
    fluid: fluidTypoStyle[props.size],
  };
                ...
                <div className="relative">
                  <div
                    className={`
                      ...
                      ${props.error && "!bg-negative-100"}
                      absolute top-0 ml-[1px] h-[1px] w-[calc(100%-2px)] bg-neutral-100
                    `}
                  />
                  <div className={`${fluidHelperTextPaddingStyle[props.size]}`}>
                    <HelperText {...props} />
                  </div>
                </div>
              )}
